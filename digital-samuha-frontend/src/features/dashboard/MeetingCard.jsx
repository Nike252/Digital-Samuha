      ...
      <div className="relative z-10">
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 mb-4 border border-white/20">
                <div className="flex items-center gap-3 mb-2">
                    <div className="bg-indigo-500 rounded-lg p-2"><Calendar size={20} className="text-white" /></div>
          ...
          {subscription?.is_premium ? (() => {
              ...
              return (
                  ...
                  >
                      {isMeetingToday ? <Video size={18} /> : <Lock size={18} />} {isMeetingToday ? "Enter Virtual Office" : "Locked (Upcoming)"}
                  </button>
              );
